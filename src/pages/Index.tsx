        ...
        <HeaderSection darkMode={darkMode}>
          <HeaderContainer>
            <HeaderContent>
              ...
              <HeaderCallButton as="a" href="tel:+18185882183">
                <Phone size={20} />
        ...
        <MainContent>
          ...
          <ContactCard darkMode={darkMode}>
            ...
            <ContactInfo>
              <ContactItem>
                <Phone size={20} />
                <ContactItemText large>
                  <a href="tel:+18185882183" style={{ color: "inherit", textDecoration: "none" }}>
                    (818) 588-2183
                  </a>
                </ContactItemText>
              </ContactItem>
              <ContactItem>
                <Mail size={20} />
                <ContactItemText large>
                  <a href="mailto:Menditappliance@gmail.com" style={{ color: "inherit", textDecoration: "none" }}>
                    Menditappliance@gmail.com
                  </a>
                </ContactItemText>
              </ContactItem>
              <ContactItem>
            ...
            <ContactButton as="a" href="tel:+18185882183">
              <Phone size={20} />
